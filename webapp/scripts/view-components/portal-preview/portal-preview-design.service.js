(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.portal-preview').factory('comVyomVyomlibPortalPreviewDesign', function (comVyomVyomlibPortalPreviewModel, rxGUID, RX_DEFINITION_PICKER) {
