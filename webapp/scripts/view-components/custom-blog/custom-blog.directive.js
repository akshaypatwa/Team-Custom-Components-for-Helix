(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.custom-blog')
        .directive('comVyomVyomlibCustomBlog',
            ...
            function (rxNotificationMessage, rxRecordInstanceDataPageResource, rxRecordInstanceResource, rxGUID, $window, rxCurrentUser, $sce, $uibModal) {
                return {
                    restrict: 'E',
                    ...
                    link: function ($scope, $element) {
                        ...
                        var init = function () {
                            ...
                            angular.element(document).ready(function () {
                                ...
                                $scope.editor = CKEDITOR.inline($scope.editorID, {
                                    ...
                                    height: '500px',
                                    extraPlugins: ['image', 'find', 'sharedspace', 'base64image', 'wsc', 'imagepaste', 'codesnippet', 'chart'],
                                    startupFocus: false,
                        ...
                        $scope.openmodal = function (size) {
                            console.log(size);
                            $uibModal.open({
                                templateUrl: "scripts/view-components/custom-blog/temp.html",
                                backdrop: "static",
                                windowClass: "rx-runtime-view-dialog modal__rx-" + size
